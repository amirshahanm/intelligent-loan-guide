...
export async function callAdminRpc<T>(name: string, body: Record<string, Json>): Promise<T> {
...
export async function insertAdminRow<T>(table: string, body: Record<string, Json>): Promise<T[]> {
